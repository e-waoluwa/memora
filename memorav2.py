...
while True:
    ...
    if choice == "1":
        ...
        print(f"✅ Saved: {item} at {location} ({time_now})")
    ...
    # FIND ITEM
        ...
        for log in reversed(memory_log):  # latest first
        ...
        if not found:
            print("❌ Item not found in memory")
